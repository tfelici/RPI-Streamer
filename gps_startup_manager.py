...
REFACTORED: Motion detection functionality has been moved to motion_detection.py module
for reuse across multiple components (startup and auto-stop monitoring).
"""
import sys
import os
import time
    ...
    try:
        ...
        if gps_start_mode == 'boot':
            ...
            if motion_detected:
                ...
                logger.info("Motion detection was interrupted")
